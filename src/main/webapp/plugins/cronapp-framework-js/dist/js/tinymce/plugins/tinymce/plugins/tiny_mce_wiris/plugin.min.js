...
// Lang.
var _wrs_int_langCode = 'pt_BR';
var langObj = {
  insertMath_en_CA: 'Insert a math equation - MathType',
  insertMath_pt_BR: 'Inserir uma equação matemática - MathType',
  insertChemistry_en_CA: 'Insert a chemistry formula - ChemType',
  insertChemistry_pt_BR:  'Inserir uma fórmula química - ChemType'
};
// Custom Editors.
var _wrs_int_customEditors = {chemistry : {name: 'Chemistry', toolbar : 'chemistry', icon : 'chem.png', enabled : false, confVariable : '_wrs_conf_chemEnabled', 
  tooltip: langObj["insertChemistry_"+_wrs_int_langCode], title : 'ChemType'}};
...
(function () {
    tinymce.create('tinymce.plugins.tiny_mce_wiris', {
        init: function (editor, url) {
            ...
            _wrs_int_langCode = editor.getParam('language');
            _wrs_int_customEditors = {chemistry : {name: 'Chemistry', toolbar : 'chemistry', icon : 'chem.png', enabled : false, confVariable : '_wrs_conf_chemEnabled', 
                                      tooltip: langObj["insertChemistry_"+_wrs_int_langCode], title : 'ChemType'}};
            ...
            if (_wrs_int_conf_async || _wrs_conf_editorEnabled) {
                ...
                editor.addButton('tiny_mce_wiris_formulaEditor', {
                    title: langObj["insertMath_" + _wrs_int_langCode],
