...
public interface BairroDAO extends JpaRepository<Bairro, java.lang.String> {
  ...
  public Bairro findOne(@Param(value="id") java.lang.String id);
  ...
  public Page<Bairro> findBairrosByCidade(@Param(value="id") java.lang.String id, Pageable pageable);
